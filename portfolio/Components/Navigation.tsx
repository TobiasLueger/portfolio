...
const Navigation = () => {
  ...
  return (
    <header className="w-full lg:w-1/4 lg:h-1/2 lg:flex lg:items-end bg-white/80 lg:bg-transparent backdrop-blur-lg lg:backdrop-blur-none fixed top-0 left-0 z-50 lg:pt-52">
